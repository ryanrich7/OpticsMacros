...
//For simulation
vector <double> Rate,Qsq,Asym,Labi,Mom;
...
//for(int i = 1; i < 6; i++){ T1->Add(Form("../sandwich/TargetMinus_SandwichRHRS_PREX_%.1f_%i.root",sept,i)); }
  for(int i = 1; i < 6; i++){ T1->Add(Form("../sandwich/SandwichRHRS_PREX_%.1f_%i.root",sept,i)); }
//for(int i = 1; i < 6; i++){ T1->Add(Form("../sandwich/TargetPlus_SandwichRHRS_PREX_%.1f_%i.root",sept,i)); }
